...
bigoffset(1)=0;
averagevalue=37.8; %average respiratory healthy rate
timepointsforoffset=2; %amount of timepoints for offsets
offset_scaling_factor = 4; %the offset's scaling factor
limitofslope=0.001; %limits the slope of offsets, you don't want them to be too high in magnitude or it won't be realistic
sublength=864; %length of subsignals;
lowervaluebound=37.5; %lower bound of where you want your signal to be, NOTE : it will slip off slightly away from this value
uppervaluebound=39; %upper bound of where u want ur signal to be, NOTE : it will slip off slightly away from this value
quantification_factor=1; %decimals kept when quantifying the signal
noisefactor=0.1; %scales the noise to the desired magnitude
...
%writematrix(wholesignal,'body_temperature.csv'), writes csv file to be used in database
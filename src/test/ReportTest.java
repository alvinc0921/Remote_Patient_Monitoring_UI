...
public class ReportTest{
    ...
    public void testrecordwriter() throws IOException {
        ...
        Reportmenu.generate_report(pat);
        boolean flag1 = false;
        Calendar calendar = Calendar.getInstance();
        Date date = calendar.getTime();
        SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy");
        String current_time = sdf.format(date);
        String file_path = System.getProperty("user.home") + System.getProperty("file.separator") + "RPM_DATA" + System.getProperty("file.separator") + "Reports" + System.getProperty("file.separator") + pat.getLastname() + "_" + pat.getFirstname() + "_" + pat.getPatID() + System.getProperty("file.separator") + pat.getLastname() + "_" + pat.getFirstname() + "_" + pat.getPatID() + "_" + current_time + ".txt";
